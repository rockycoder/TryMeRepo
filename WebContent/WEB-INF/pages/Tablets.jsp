...
<div class="products-container container" id="Main_Div">
			...
			<div class="products-container container">
				<ul class="nav-products">
					<li class="col-xs-2"><a href="#"><img src="img/products1.jpg" alt="product" /><span class="title-product">Samsung Tab</span></a></li>
					<li class="col-xs-2"><a href="#"><img src="img/products1.jpg" alt="product" /><span class="title-product">I Pad Air </span></a></li>
					<li class="col-xs-2"><a href="#"><img src="img/products1.jpg" alt="product" /><span class="title-product">Lenovo Pad</span></a></li>
					<li class="col-xs-2"><a href="#"><img src="img/products1.jpg" alt="product" /><span class="title-product">Microsoft Pad</span></a></li>
			...
			<div class="maincontent container">
				<div class="top-product col-md-6">
					<div class="top-product-title">
						<span>Top Tablet of the Week</span>
					</div>
				...
				<div class="latest-product col-md-6">
					...
					<div class="panel-heading latest-product-title"> <span>Latest Tablets</span></div>
